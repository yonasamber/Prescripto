...
const Doctors = () => {
  ...
  const [fileterDoc, setFileterDoc] = useState([]);
  ...
  const applyFilter = () => {
    if (speciality) {
      setFileterDoc(doctors.filter((doc) => doc.speciality === speciality));
    } else {
      setFileterDoc(doctors);
    }
  };
  ...
  return (
    <div>
      <p className="text-gray-600">Browse through Spcialist Doctors.</p>
